...
const ApplicationTable = () => {
  ...
  const columns = [
...

    {
      cell: row => (
        role !== 'admin' && 
        <Button href={`/main/application_update/${row.id}`} type="primary" >Edit</Button>
      ),
      ignoreRowClick: true,
      allowOverflow: true,
      button: true,
    ...
    {
        cell: row => ( role === 'admin' ? <Button  href={`/main/application_details/${row.id}`} type="primary" >Review</Button>:
        <Button  href={`/main/application_details/${row.id}`} type="primary" >View</Button>
        ), 
    ...
    {
        cell: row => (role !== 'admin' && <Button onClick={() => handleDelete(row.id)} type="primary" danger>Delete</Button>),        
        ignoreRowClick: true,
        allowOverflow: true,
        button: true
    },
